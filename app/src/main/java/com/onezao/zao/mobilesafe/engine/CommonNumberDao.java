...
public class CommonNumberDao {
    private static String tag = "Zao";
    private static String mAddress = "未知号码";
    //1. 指定访问数据库的路径
    public static String path = "data/data/com.onezao.zao.mobilesafe/files/commonnum.db";
//    public static String path = Environment.getExternalStorageDirectory() + "/ame/" + "commonnum.db";
    //2.开启数据库（组）
