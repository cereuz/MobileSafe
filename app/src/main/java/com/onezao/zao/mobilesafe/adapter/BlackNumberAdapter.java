...
public class BlackNumberAdapter extends RecyclerView.Adapter<BlackNumberAdapter.ViewHolder>{
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View view) {
            super(view);
            tv_bn_phone = (TextView) view.findViewById(R.id.tv_bn_phone);
            tv_bn_mode = (TextView) view.findViewById(R.id.tv_bn_mode);
            tv_bn_time = (TextView) view.findViewById(R.id.tv_bn_time);
            iv_bn_delete = (ImageView)view.findViewById(R.id.iv_bn_delete);
        }
    }

    public BlackNumberAdapter(List<BlackNumberInfo> mBlackNumberInfoList) {
    ...
    public void onBindViewHolder(BlackNumberAdapter.ViewHolder holder, final int position) {
        BlackNumberInfo  blackNumberInfo = mBlackNumberInfoList.get(position);
