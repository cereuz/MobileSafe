...
public class AddressDao {
    ...
    //1. 指定访问数据库的路径
    public static String path = "data/data/com.onezao.zao.mobilesafe/files/address.db";
//    public static String path = Environment.getExternalStorageDirectory() + "/ame/" + "address.db";
